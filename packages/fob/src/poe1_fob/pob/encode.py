...
def encode_pob_code(
    *,
    ...
    Args:
        ...
        tree: which passive nodes are allocated.
...
def _build_notes(
    ...
    lines: list[str] = [
        f"Stage: {tree.stage_key.replace('_', ' ').title()}",
