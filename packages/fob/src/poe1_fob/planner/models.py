...
# Trade-search HTTP shapes (TradeSearchRequest/Response, TradeModExtract*,
# ExtractedTradeMod, TradeSearchModFilter) were removed alongside the
# /fob/trade-search and /fob/extract-trade-mods endpoints — the frontend
# now redirects directly to pathofexile.com/trade with the item name in
# the clipboard. See apps/shell/src/api/tradeRedirect.ts.
