...
- **FOB is live in production**, free tier:
  ...
  - Cost: **$0/month**.
- **Baseline gate**: 755 tests green / 132 mypy / ruff clean.
- **Working features (all QA-verified or post-QA fixed)**:
  ...
  - Theorycrafter viability report (Step 43) + connected BFS passive tree path (Step 44) + full-budget tree fill ~120 nodes (Step 45a) + deduplicated gem layout with compatible supports (Step 45b) + 3.28 Awakened gem allowlist (Step 45c) + realistic per-slot item affixes (Step 45d) + localised tree pathing (Step 46) + real item mods via RePoE (Step 47). ✅
...
**Baseline gate (current): 755 tests green / 132 mypy / ruff clean.**
...
- _(none — Theorycrafter QA items from 2026-05-22 all shipped: gem links 45b/c, real affixes 45d, localised tree 46, real item mods 47)_
