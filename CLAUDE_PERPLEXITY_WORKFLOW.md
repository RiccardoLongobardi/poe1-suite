...
- **FOB is live in production**, free tier:
  ...
  - Cost: **$0/month**.
- **Baseline gate**: 752 tests green / 132 mypy / ruff clean.
- **Working features (all QA-verified or post-QA fixed)**:
  ...
  - Theorycrafter viability report (Step 43) + connected BFS passive tree path (Step 44) + full-budget tree fill ~120 nodes (Step 45a) + deduplicated gem layout with compatible supports (Step 45b) + 3.28 Awakened gem allowlist (Step 45c). ✅
...
**Baseline gate (current): 752 tests green / 132 mypy / ruff clean.**
